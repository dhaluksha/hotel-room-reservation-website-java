...
<head>
    <meta charset="UTF-8"/>
    <title>Reservation | Golden Grand Hotels</title>
...
<div id="displaysuccess">
    ...
    <div id="nav">
        <div id="logo">    <a href="home"> <img style="width: 130px;height: 50px;margin-top: -5px;filter: brightness(0) invert(1);" src="img/GOLDEN_GRAND1.png"></a>&nbsp; - &nbsp;&nbsp;<%= session.getAttribute("hotel") %>
        </div>
    </div>
    <br><br>
    <div class="container">
